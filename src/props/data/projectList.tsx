...
export const projectList: Array<ProjectPropsDto> = [
  {
    ...
    description: 'A mini project for college purpose which converts text to speech and speech to text. ',
  },
  {
    image: (
      <svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
    ...
    description: 'This repository contains a real-time chat application built using Node.js, Express, Socket.io, and React ',
  },
  {
    image: (
      <svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
    ...
    title: 'Email Engine',
    link: 'https://github.com/PrajwalSh0206/Email-Engine',
    description:
      'Our Email Engine is a robust and scalable solution built using Node.js and React to seamlessly fetch, list, and manage emails from third-party providers directly on our platform.',
  },
];
