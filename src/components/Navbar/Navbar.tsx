...
const Navbar: React.FC<NavbarProps> = function ({ display, setToggleDisplay }) {
  ...
  return (
    <div
      ref={ref}
      className={`flex flex-col items-center space-y-3 transition-all duration-500 lg:sticky top-0 text-white px-5 py-10 md:px-10 md:py-10 w-8/12 md:w-5/12 z-50 lg:w-3/12 h-screen bg-gray-800 fixed ${
