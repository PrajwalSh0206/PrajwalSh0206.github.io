        ...
        <div className='w-full flex flex-col' id='contactme'>
            ...
            <div className='w-full p-5 flex text-white justify-between bg-indigo-900'>
                <div className='flex space-x-2'>
                    ...
                    <p>Icons By:</p> <a className='underline' target='_blank' href='https://iconoir.com/'>Iconoir</a>
                </div>
                <div className='flex space-x-2'>
                    ...
                    <p>Illustration Credited By:</p> <a className='underline' target='_blank' href='https://www.manypixels.co/gallery'>Many Pixel</a>
                </div>
            </div>
        </div>
    )
