...
const Projects = () => {
  return (
    <div className="w-full flex flex-col space-y-5 items-center md:items-start p-10 lg:p-20 bg-gray-700 border-t-2 text-white border-gray-400" id="projects">
      ...
      <div className="w-full flex flex-col md:flex-row space-y-5 md:space-x-5">
        {projectList.map(val => (
          <a href={val.link} className="w-full md:w-6/12 p-5 rounded-md border-white bg-white shadow-md text-black border-2 flex space-x-3 items-center">
