...
function SkillPage() {
        ...
        return (
            <div className='w-full bg-indigo-50 border-y-2 border-indigo-400 flex flex-col '>
                <div className='w-full items-center justify-center py-5 text-indigo-900 flex space-x-5 '>
